...
public class Traditional401kGUI extends JFrame{
    //instance variables
    ...
    public Traditional401kGUI() {
        ...
        this.chartPanel = new XChartPanel<>(Graphfor401k.createChart("Traditional 401k Calculator"));
        
        
        // Set up the frame layout
        this.setTitle("401k Calculator");
        this.setLayout(new BorderLayout());
        
        // Create input panel
        JPanel inputPanel = new JPanel(new GridLayout(22,1,5,5));
        ...
        calculateButton.addActionListener(e -> {
            try {
                ...
                Traditional401kMath traditional401kMath = new Traditional401kMath(
                ...
                calculateAndDisplayChart(traditional401kMath);
        ...
        XYChart chart = Graphfor401k.createChart("Traditional 401k Balance Projection");
    ...
    private void calculateAndDisplayChart(RetirementAccount account) {
        ...
        for (int age = currentAge; age <= retirementAge; age++) {
            ...
            if (age == currentAge) {
                ...
                Traditional401kMath traditional401kMath = (Traditional401kMath) account;
                yearlyContribution = traditional401kMath.calculateEmployeeContribution();
                employerContribution = traditional401kMath.calculateEmployerContribution();
                traditional401kMath.setSalary(traditional401kMath.calculateSalary()); // Update salary for next year
    ...
    private JPanel createSummaryPanel(double totalEmployeeContributions, double totalEmployerContributions, double finalBalance) {
        ...
        panel.add(new JLabel("Total Employee Contributions: " + String.format("$%,.2f", totalEmployeeContributions)));
