...
public class TraditionalIRAGUI extends JFrame {
    ...
    public TraditionalIRAGUI() {
        setTitle("Traditional IRA Calculator (2026 Rules)");
        setSize(1000,900);
        ...
        inputPanel.add(new JLabel("Return Rate (%):")); 
        ...
        finalBalanceLabel = new JLabel("Final Balance After Deducting Marginal Tax: $0.00", SwingConstants.CENTER);
        ...
        chart = GraphForIRA.createIRAChart("Traditional IRA Growth");
    ...
    private void calculate() {
        try {
            ...
            TraditionalIRAMath math = new TraditionalIRAMath(bal, cur, ret, rate, con, tax, isMaximized);
            finalBalanceLabel.setText("Final Balance  After Deducting Marginal Tax: $" + String.format("%.2f", math.calculateFinalBalance(isMaximized)));
